          ...
          <div className="row justify-content-md-center">
            <div className="col-lg-11">
              <div className="main-wraper">
                <h4 className="main-title">Our Prices</h4>
                <h6 className="mb-4">Our prices included with tax and charged automated every month of 15th.</h6>
                <div className="price-plan-wraper">
                  <table className="table table-striped table-responsive-md">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><i className="icofont-verification-check" /></td>
                        <td><i className="icofont-verification-check" /></td>
                        <td><i className="icofont-verification-check" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="not-included"><i className="icofont-verification-check" /></td>
                        <td><i className="icofont-verification-check" /></td>
                        <td><i className="icofont-verification-check" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td colSpan={1} />
                        <td>
                          <a href="#" title className="button outline-primary">Choose Plan</a>
                        </td>
                        <td>
                          <a href="#" title className="button outline-primary">Choose Plan</a>
                        </td>
                  ...
                  <h5><i className="icofont-crown-queen" /> More Powerful Features <b>Coming Soon!</b></h5>
                </div>
              </div>
              <div className="main-wraper">
                <ul className="pplan-links">
                  <li>Prices are in USD. Don't have a credit card? 
                    <a href="#" title>Pay With <i className="icofont-paypal-alt" /></a>
                  </li>
                  <li>Already subscribed and want to upgrade or downgrade? 
                    <a href="#" title>The easy way <i className="icofont-settings" /></a>
                  </li>
                  <li>Questions? 
                    <a href="#" title>Go to FAQ's <i className="icofont-question-circle" /></a>
                  </li>
                  <li>Trouble Shooting 
                    <a href="#" title> Contact our Team <i className="icofont-team" /></a>
                  </li>
                </ul>
              </div>
            </div>
