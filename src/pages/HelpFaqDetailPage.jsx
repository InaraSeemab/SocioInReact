...
export default function helpfaqdetailPage() {
  return (
    <>
      <Header />
      <Sidebar />
                ...
                <div id="page-contents" className="row merged20">
                  <div className="col-lg-9">
                    <div className="main-wraper">
                      <h4 className="main-title">how to Promote Your Course With Coupons and Referral Links</h4>
                      <div className="help-detail">
                        ...
                        <div className="gallery">
                          <div className="row">
                            <div className="col-lg-4">
                              <div className="uk-card uk-card-default"><img src="https://wpkixx.com/html/socimo/images/resources/course-1.jpg" alt /></div>
                            </div>
                            <div className="col-lg-4">
                              <div className="uk-card uk-card-default"><img src="https://wpkixx.com/html/socimo/images/resources/course-4.jpg" alt /></div>
                            </div>
                            <div className="col-lg-4">
                              <div className="uk-card uk-card-default"><img src="images/resources/course-3.jpg" alt /></div>
                            </div>
                          </div>
                        </div>
                        <h4>Help Tile write here</h4>
                        <p>
                        ...
                        <h4>How to find the new user</h4>
                        <ol className="ol-list">
                          <li>Go to your index page</li>
                          <li>see the setting panel</li>
                          <li>click on setting</li>
                          <li>go to search filter</li>
                          <li>write name and search</li>
                        </ol>
                        <div className="is-helpful">
                          <span>is this topic helpful for you ?</span>
                          <a className="button primary circle" title href="#">Yes</a>
                          <a className="button primary circle" title href="#">No</a>
                          <a className="button primary circle" title href>Need more Help</a>
                          <em>80% users like this article</em>
                        </div>
                        <div className="share-article">
                          <span>share this article to social media</span>
                          <a className="facebook" title href="#"><i className="icofont-facebook" /></a>
                          <a className="pinterest" title href="#"><i className="icofont-pinterest" /></a>
                          <a className="instagram" title href="#"><i className="icofont-instagram" /></a>
                          <a className="twitter" title href="#"><i className="icofont-twitter" /></a>
                          <a className="google" title href="#"><i className="icofont-google-plus" /></a>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <aside className="sidebar static right">
                      ...
                      <div className="widget stick-widget">
                        ...
                        <ul className="pop-articles">
                          <li><i className="icofont-dotted-right" /><a href="#" title>Can't login to Socimo</a></li>
                          <li><i className="icofont-dotted-right" /><a href="#" title>Account settings</a></li>
                          <li><i className="icofont-dotted-right" /><a href="#" title>Edit Account Name</a></li>
                          <li><i className="icofont-dotted-right" /><a href="#" title>Following and unfollowing</a></li>
                          <li><i className="icofont-dotted-right" /><a href="#" title>Logout from Socimo</a></li>
                          <li><i className="icofont-dotted-right" /><a href="#" title>Deactive/close your account</a></li>
                        </ul>
                      </div>
                    </aside>
                  </div>
