  ...
  <div className="theme-layout">
    ...
    <header className="transparent">
      <div className="topbar">
        ...
        <ul>
          ...
          <li><a href="#" title><img src="https://wpkixx.com/html/socimo/images/flags/US.png" alt /></a></li>
    ...
    <section>
      <div className="gap overlap nogap mate-black low-opacity">
        <div className="bg-image" style={{backgroundImage: 'url(https://wpkixx.com/html/socimo/images/resources/slider3.jpg)'}} />
          ...
          <div className="row">
            ...
            <div className="col-lg-5 col-md-5">
              <figure className="side-image">
                <img src="https://wpkixx.com/html/socimo/images/resources/research-avatar.jpg" alt />
              </figure>
            </div>
          </div>
        </div>
      ...
      <div className="gap">
        <div className="container">
          <div className="row">
            <div className="col-lg-5 col-md-5">
              <figure className="side-image">
                <img src="https://wpkixx.com/html/socimo/images/resources/research-avatar2.jpg" alt />
              </figure>
            </div>
            <div className="col-lg-7 col-md-7">
              <div className="verticle-center">
    ...
    <section>
      <div className="gap mate-black low-opacity">
        <div className="bg-image" style={{backgroundImage: 'url(https://wpkixx.com/html/socimo/images/resources/paralex-bg.jpg)'}} data-velocity=".2" />
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="welcome-parallax">
                <i><img src="https://wpkixx.com/html/socimo/images/tv-icon.png" alt /></i>
          ...
          <div className="row remove-ext30">
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="blog-grid">
                <figure><img src="https://wpkixx.com/html/socimo/images/resources/blog.jpg" alt /></figure>
                <div className="blog-meta">
                  <div className="blog-head">
                    <ul className="postby">
                      <li>
                        <figure><img src="https://wpkixx.com/html/socimo/images/resources/postby1.jpg" alt /></figure> 
                        <span>Saden joe</span>
                      </li>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="blog-grid">
                <figure><img src="https://wpkixx.com/html/socimo/images/resources/blog2.jpg" alt /></figure>
                <div className="blog-meta">
                  <div className="blog-head">
                    <ul className="postby">
                      <li>
                        <figure><img src="https://wpkixx.com/html/socimo/images/resources/postby2.jpg" alt /></figure> 
                        <span>Andrew</span>
                      </li>
                      <li><i className="icofont-heart" /><span>1.3k</span></li>
                    </ul>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="blog-grid">
                <figure><img src="https://wpkixx.com/html/socimo/images/resources/blog3.jpg" alt /></figure>
                <div className="blog-meta">
                  <div className="blog-head">
                    <ul className="postby">
                      <li>
                        <figure><img src="https://wpkixx.com/html/socimo/images/resources/postby3.jpg" alt /></figure> 
                        <span>Emma Lucy</span>
                      </li>
                      <li><i className="icofont-heart" /><span>1.3k</span></li>
                    </ul>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="newsletter-sec">
                <figure><img src="https://wpkixx.com/html/socimo/images/news-icon.png" alt /></figure>
            ...
            <div className="col-lg-12">
              <div className="student-review">
                <div className="review-item">
                  <figure><img src="https://wpkixx.com/html/socimo/images/resources/commenter-1.jpg" alt /></figure>
                  <h6>Emma Watson</h6>
                ...
                <div className="review-item">
                  <figure><img src="https://wpkixx.com/html/socimo/images/resources/commenter-2.jpg" alt /></figure>
                  <h6>Emma Watson</h6>
                  <span>Student of Botony</span>
                  <p>
                    Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus.	 
                ...
                <div className="review-item">
                  <figure><img src="https://wpkixx.com/html/socimo/images/resources/commenter-3.jpg" alt /></figure>
                  <h6>Emma Watson</h6>
                  <span>Student of Botony</span>
                  <p>
                    Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus.	 
