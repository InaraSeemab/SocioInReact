                        ...
                        <aside className="sidebar static left">
                          <div className="widget">
                            ...
                            <ul className="sponsors-ad">
                              <li>
                                <figure><img alt src="https://wpkixx.com/html/socimo/images/resources/sponsor.jpg" /></figure>
                              ...
                              <li>
                                <figure><img alt src="https://wpkixx.com/html/socimo/images/resources/sponsor2.jpg" /></figure>
                                <div className="sponsor-meta">
                            ...
                            <ul className="ak-groups">
                              <li>
                                ...
                                <div className="your-grp">
                                  ...
                                  <a className="promote" title href="https://wpkixx.com/html/socimo/group-feed.html">view feed</a>
                                </div>
                              </li>
                              <li>
                                <figure><img alt src="https://wpkixx.com/html/socimo/images/resources/your-group2.jpg" /></figure>
                                <div className="your-grp">
                      ...
                      <div className="col-lg-9">
                        <div className="group-feed">
                          <div className="group-avatar">
                            <img src="https://wpkixx.com/html/socimo/images/resources/profile-banner.jpg" alt />
                            ...
                            <div className="grp-about">
                              <div className="row">
                                <div className="col-lg-8 col-md-6">
                                  ...
                                  <ul className="badges">
                                    <li><img src="https://wpkixx.com/html/socimo/images/badges/badge2.png" alt /></li>
                                    <li><img src="https://wpkixx.com/html/socimo/images/badges/badge3.png" alt /></li>
                                    <li><img src="https://wpkixx.com/html/socimo/images/badges/badge4.png" alt /></li>
                                    <li><img src="https://wpkixx.com/html/socimo/images/badges/badge5.png" alt /></li>
                                    <li><img src="https://wpkixx.com/html/socimo/images/badges/badge7.png" alt /></li>
                                    <li><img src="https://wpkixx.com/html/socimo/images/badges/badge8.png" alt /></li>
                                  </ul>
                                </div>
                                        ...
                                        <div className="user-post">
                                          <div className="friend-info">
                                            ...
                                            <div className="friend-name">
                                              ...
                                              <ins><a title href="https://wpkixx.com/html/socimo/time-line.html">Jack Carter</a> Share Post</ins>
                                        ...
                                        <div className="user-post">
                                          <div className="friend-info">
                                            ...
                                            <div className="friend-name">
                                              ...
                                              <ins><a title href="https://wpkixx.com/html/socimo/time-line.html">Georg Peeter</a> Premium Product</ins>
                                              <span><i className="icofont-globe" /> published: Sep,15 2020</span>
                                            </div>
                                            <div className="post-meta">
                                        ...
                                        <div className="user-post">
                                          <div className="friend-info">
                                            ...
                                            <div className="friend-name">
                                              ...
                                              <ins><a title href="https://wpkixx.com/html/socimo/time-line.html">Georg Peeter </a> Create Post</ins>
                                              <span><i className="icofont-globe" /> published: Sep,15 2020</span>
                                            </div>
                                            <div className="post-meta">
                                              <figure>
                                        ...
                                        <div className="user-post">
                                          <div className="friend-info">
                                            ...
                                            <div className="friend-name">
                                              ...
                                              <ins><a title href="https://wpkixx.com/html/socimo/time-line.html">Georg Peeter </a> added image album</ins>
                                              <span><i className="icofont-globe" /> published: Sep,15 2020</span>
                                            </div>
                                            <div className="post-meta">
                                              <figure>
                                        ...
                                        <div className="user-post">
                                          <div className="friend-info">
                                            ...
                                            <div className="friend-name">
                                              ...
                                              <ins><a title href="https://wpkixx.com/html/socimo/time-line.html">Georg Peeter </a> Shared Link</ins>
                                              <span><i className="icofont-globe" /> published: Sep,15 2020</span>
                                            </div>
                                            <div className="post-meta">
                                      ...
                                      <div className="main-wraper">
                                        <div className="user-post">
                                          <div className="friend-info">
                                            ...
                                            <div className="post-meta">
                                              <img className="gif" src="https://wpkixx.com/html/socimo/images/giphy.png" data-gif="images/giphy-sample.gif" alt />
                                              <div className="we-video-info">
                                                <ul>
                                                  <li>
                                                    <span title="views" className="views">
                                      ...
                                      <aside className="sidebar static left">
                                        ...
                                        <div className="widget">
                                          ...
                                          <ul className="invitepage">
                                            <li>
                                              <figure>
                                                <img alt src="https://wpkixx.com/html/socimo/images/resources/friend-avatar.jpg" />
                                            ...
                                            <li>
                                              <figure>
                                                <img alt src="https://wpkixx.com/html/socimo/images/resources/friend-avatar2.jpg" />
                                            ...
                                            <li>
                                              <figure>
                                                <img alt src="https://wpkixx.com/html/socimo/images/resources/friend-avatar3.jpg" />
                                                <a href>Andrew</a>
                                              </figure>
                                              <button className="sug-like"><i className="invit">Follow</i><i className="icofont-check-alt" /></button>
                                            </li>
                                            <li>
                                              <figure>
                                                <img alt src="https://wpkixx.com/html/socimo/images/resources/friend-avatar4.jpg" />
                                            ...
                                            <li>
                                              <figure>
                                                <img alt src="https://wpkixx.com/html/socimo/images/resources/friend-avatar5.jpg" />
                                        ...
                                        <div className="widget">
                                          ...
                                          <div className="recent-media">
                                            <figure>
                                              <img src="https://wpkixx.com/html/socimo/images/resources/user-video7.jpg" alt />
                                            ...
                                            <figure>
                                              <img src="https://wpkixx.com/html/socimo/images/resources/user-video10.jpg" alt />
                                              <a className="play-btn" data-fancybox href="https://www.youtube.com/embed/vP-l9L3Ku5Y"><i className="icofont-play" /></a>
                                ...
                                <div className="tab-pane fade" id="pictures">
                                  ...
                                  <div className="row merged-10">
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="uzr-pictures">
                                        <a href="#" data-target="#img-comt" data-toggle="modal">
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-pic1.jpg" />
                                        </a>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="uzr-pictures">
                                        <a href="#" data-target="#img-comt" data-toggle="modal">
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-pic2.jpg" />
                                        </a>
                                        <ul className="hover-action">
                                          <li><a href="#" title><i className="icofont-like" /> 3</a></li>
                                          <li><a href="#" title><i className="icofont-chat" /> 5</a></li>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="uzr-pictures">
                                        <a href="#" data-target="#img-comt" data-toggle="modal">
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-pic3.jpg" />
                                        </a>
                                        <ul className="hover-action">
                                          <li><a href="#" title><i className="icofont-like" /> 3</a></li>
                                          <li><a href="#" title><i className="icofont-chat" /> 5</a></li>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="uzr-pictures">
                                        <a href="#" data-target="#img-comt" data-toggle="modal">
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-pic4.jpg" />
                                        </a>
                                        <ul className="hover-action">
                                          <li><a href="#" title><i className="icofont-like" /> 3</a></li>
                                          <li><a href="#" title><i className="icofont-chat" /> 5</a></li>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="uzr-pictures">
                                        <a href="#" data-target="#img-comt" data-toggle="modal">
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-pic5.jpg" />
                                        </a>
                                        <ul className="hover-action">
                                          <li><a href="#" title><i className="icofont-like" /> 3</a></li>
                                          <li><a href="#" title><i className="icofont-chat" /> 5</a></li>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="uzr-pictures">
                                        <a href="#" data-target="#img-comt" data-toggle="modal">
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-pic6.jpg" />
                                        </a>
                                        <ul className="hover-action">
                                          <li><a href="#" title><i className="icofont-like" /> 3</a></li>
                                          <li><a href="#" title><i className="icofont-chat" /> 5</a></li>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="uzr-pictures">
                                        <a href="#" data-target="#img-comt" data-toggle="modal">
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-pic7.jpg" />
                                        </a>
                                        <ul className="hover-action">
                                          <li><a href="#" title><i className="icofont-like" /> 3</a></li>
                                          <li><a href="#" title><i className="icofont-chat" /> 5</a></li>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="uzr-pictures">
                                        <a href="#" data-target="#img-comt" data-toggle="modal">
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-pic8.jpg" />
                                        </a>
                                        <ul className="hover-action">
                                          <li><a href="#" title><i className="icofont-like" /> 3</a></li>
                                          <li><a href="#" title><i className="icofont-chat" /> 5</a></li>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="uzr-pictures">
                                        <a href="#" data-target="#img-comt" data-toggle="modal">
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-pic9.jpg" />
                                        </a>
                                        <ul className="hover-action">
                                          <li><a href="#" title><i className="icofont-like" /> 3</a></li>
                                          <li><a href="#" title><i className="icofont-chat" /> 5</a></li>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="uzr-pictures">
                                        <a href="#" data-target="#img-comt" data-toggle="modal">
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-pic10.jpg" />
                                        </a>
                                        <ul className="hover-action">
                                          <li><a href="#" title><i className="icofont-like" /> 3</a></li>
                                          <li><a href="#" title><i className="icofont-chat" /> 5</a></li>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="uzr-pictures">
                                        <a href="#" data-target="#img-comt" data-toggle="modal">
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-pic11.jpg" />
                                        </a>
                                        <ul className="hover-action">
                                          <li><a href="#" title><i className="icofont-like" /> 3</a></li>
                                          <li><a href="#" title><i className="icofont-chat" /> 5</a></li>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="uzr-pictures">
                                        <a href="#" data-target="#img-comt" data-toggle="modal">
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-pic12.jpg" />
                                        </a>
                                        <ul className="hover-action">
                                          <li><a href="#" title><i className="icofont-like" /> 3</a></li>
                                          <li><a href="#" title><i className="icofont-chat" /> 5</a></li>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="uzr-pictures">
                                        <a href="#" data-target="#img-comt" data-toggle="modal">
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-pic13.jpg" />
                                        </a>
                                        <ul className="hover-action">
                                          <li><a href="#" title><i className="icofont-like" /> 3</a></li>
                                          <li><a href="#" title><i className="icofont-chat" /> 5</a></li>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="uzr-pictures">
                                        <a href="#" data-target="#img-comt" data-toggle="modal">
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-pic14.jpg" />
                                        </a>
                                        <ul className="hover-action">
                                          <li><a href="#" title><i className="icofont-like" /> 3</a></li>
                                          <li><a href="#" title><i className="icofont-chat" /> 5</a></li>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="uzr-pictures">
                                        <a href="#" data-target="#img-comt" data-toggle="modal">
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-pic15.jpg" />
                                        </a>
                                        <ul className="hover-action">
                                          <li><a href="#" title><i className="icofont-like" /> 3</a></li>
                                          <li><a href="#" title><i className="icofont-chat" /> 5</a></li>
                                  ...
                                  <div className="row merged-10">
                                    <div className="col-lg-4 col-md-4 col-sm-6">
                                      <div className="user-video">
                                        <figure>
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-video1.jpg" />
                                    ...
                                    <div className="col-lg-4 col-md-4 col-sm-6">
                                      <div className="user-video">
                                        <figure>
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-video2.jpg" />
                                          <a href="https://www.youtube.com/embed/vP-l9L3Ku5Y" data-fancybox className="play-btn"><i className="icofont-play" /></a>
                                        </figure>
                                    ...
                                    <div className="col-lg-4 col-md-4 col-sm-6">
                                      <div className="user-video">
                                        <figure>
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-video3.jpg" />
                                          <a href="https://www.youtube.com/embed/vP-l9L3Ku5Y" data-fancybox className="play-btn"><i className="icofont-play" /></a>
                                        </figure>
                                        <span>Pool Party 2020</span>
                                        <ul className="vid-action">
                                    ...
                                    <div className="col-lg-4 col-md-4 col-sm-6">
                                      <div className="user-video">
                                        <figure>
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-video4.jpg" />
                                          <a href="https://www.youtube.com/embed/vP-l9L3Ku5Y" data-fancybox className="play-btn"><i className="icofont-play" /></a>
                                        </figure>
                                    ...
                                    <div className="col-lg-4 col-md-4 col-sm-6">
                                      <div className="user-video">
                                        <figure>
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-video5.jpg" />
                                          <a href="https://www.youtube.com/embed/vP-l9L3Ku5Y" data-fancybox className="play-btn"><i className="icofont-play" /></a>
                                        </figure>
                                    ...
                                    <div className="col-lg-4 col-md-4 col-sm-6">
                                      <div className="user-video">
                                        <figure>
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-video6.jpg" />
                                          <a href="https://www.youtube.com/embed/vP-l9L3Ku5Y" data-fancybox className="play-btn"><i className="icofont-play" /></a>
                                        </figure>
                                    ...
                                    <div className="col-lg-4 col-md-4 col-sm-6">
                                      <div className="user-video">
                                        <figure>
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-video7.jpg" />
                                          <a href="https://www.youtube.com/embed/vP-l9L3Ku5Y" data-fancybox className="play-btn"><i className="icofont-play" /></a>
                                        </figure>
                                    ...
                                    <div className="col-lg-4 col-md-4 col-sm-6">
                                      <div className="user-video">
                                        <figure>
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-video8.jpg" />
                                          <a href="https://www.youtube.com/embed/vP-l9L3Ku5Y" data-fancybox className="play-btn"><i className="icofont-play" /></a>
                                        </figure>
                                    ...
                                    <div className="col-lg-4 col-md-4 col-sm-6">
                                      <div className="user-video">
                                        <figure>
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-video9.jpg" />
                                          <a href="https://www.youtube.com/embed/vP-l9L3Ku5Y" data-fancybox className="play-btn"><i className="icofont-play" /></a>
                                        </figure>
                                    ...
                                    <div className="col-lg-4 col-md-4 col-sm-6">
                                      <div className="user-video">
                                        <figure>
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-video10.jpg" />
                                          <a href="https://www.youtube.com/embed/vP-l9L3Ku5Y" data-fancybox className="play-btn"><i className="icofont-play" /></a>
                                        </figure>
                                    ...
                                    <div className="col-lg-4 col-md-4 col-sm-6">
                                      <div className="user-video">
                                        <figure>
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-video11.jpg" />
                                          <a href="https://www.youtube.com/embed/vP-l9L3Ku5Y" data-fancybox className="play-btn"><i className="icofont-play" /></a>
                                        </figure>
                                    ...
                                    <div className="col-lg-4 col-md-4 col-sm-6">
                                      <div className="user-video">
                                        <figure>
                                          <img alt src="https://wpkixx.com/html/socimo/images/resources/user-video12.jpg" />
                                          <a href="https://www.youtube.com/embed/vP-l9L3Ku5Y" data-fancybox className="play-btn"><i className="icofont-play" /></a>
                                        </figure>
                                  ...
                                  <div className="row merged-10 col-xs-6">
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="friendz">
                                        <figure><img src="https://wpkixx.com/html/socimo/images/resources/speak-10.jpg" alt /></figure>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="friendz">
                                        <figure><img src="https://wpkixx.com/html/socimo/images/resources/speak-11.jpg" alt /></figure>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="friendz">
                                        <figure><img src="https://wpkixx.com/html/socimo/images/resources/speak-12.jpg" alt /></figure>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="friendz">
                                        <figure><img src="https://wpkixx.com/html/socimo/images/resources/speak-4.jpg" alt /></figure>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="friendz">
                                        <figure><img src="https://wpkixx.com/html/socimo/images/resources/speak-5.jpg" alt /></figure>
                                        <span><a href="#" title>Amy Watson</a></span>
                                        <ins>Bz University, Pakistan</ins>
                                        <a href="#" title data-ripple><i className="icofont-star" /> Unfollow</a>
                                      </div>
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6">
                                      <div className="friendz">
                                        <figure><img src="https://wpkixx.com/html/socimo/images/resources/speak-7.jpg" alt /></figure>
                                        <span><a href="#" title>Muhammad Khan</a></span>
                                        <ins>Oxford University, UK</ins>
                                        <a href="#" title data-ripple><i className="icofont-star" /> Unfollow</a>
                                      </div>
                    ...
                    <div className="col-lg-9">
                      <div className="pop-image">
                        <div className="pop-item">
                          ...
                          <figure><img src="https://wpkixx.com/html/socimo/images/resources/blog-detail.jpg" alt /></figure>
                          <div className="stat-tools">
                            <div className="box">
                              <div className="Like"><a className="Like__link"><i className="icofont-like" /> Like</a>
                                <div className="Emojis">
                        ...
                        <div className="we-video-info">
                          ...
                          <div className="users-thumb-list">
                            <a href="#" title data-toggle="tooltip" data-original-title="Anderw">
                              <img src="https://wpkixx.com/html/socimo/images/resources/userlist-1.jpg" alt />
                            </a>
                            <a href="#" title data-toggle="tooltip" data-original-title="frank">
                              <img src="https://wpkixx.com/html/socimo/images/resources/userlist-2.jpg" alt />
                            </a>
