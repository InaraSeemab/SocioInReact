            ...
            <div className="offset-lg-1 col-lg-10">
              <div className="blog-detail">
                ...
                <div className="blog-details-meta">
                  <figure><img src="https://wpkixx.com/html/socimo/images/resources/blog-detail.png" alt /></figure>
                  <ul>
                    <li><i className>
                        <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" /><circle cx={12} cy={12} r={3} /></svg></i> 907</li>
                    <li><i className>
                  ...
                  <div className="tag-n-cat">
                    ...
                    <div className="tags">
                      <span><i className>
                          <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="feather feather-filter"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3" /></svg></i> Post Categories:</span>
                      <a title href="#">News</a>
                      <a title href="#">ideas</a>
                      <a title href="#">collection</a>
                      <a title href="#">exclusive</a>
