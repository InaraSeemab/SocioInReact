                  ...
                  <div className="col-lg-12">
                    <div className="post-subject">
                      ...
                      <ul className="nav nav-tabs post-detail-btn">
                        <li className="nav-item"><a className="active" href="#allposts" data-toggle="tab">All Posts</a></li>
                        <li className="nav-item"><a className href="#depart" data-toggle="tab">Departments</a></li>
                        <li className="nav-item"><a className href="#members" data-toggle="tab">Members</a></li>
                      ...
                      <div className="col-lg-8">
                        <div className="tab-content">
                              ...
                              <div className="row merged-10 remove-ext20">
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="images-post">
                                    <a className="uk-inline" href="https://wpkixx.com/html/socimo/images/elements/light.jpg" data-fancybox>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="images-post">
                                    <a className="uk-inline" href="https://wpkixx.com/html/socimo/images/elements/dark.jpg" data-fancybox>
                                      <img src="https://wpkixx.com/html/socimo/images/elements/dark.jpg" alt />
                                    </a>
                                  </div>
                                </div>
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="images-post">
                                    <a className="uk-inline" href="https://wpkixx.com/html/socimo/images/elements/image.jpg" data-fancybox>
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="images-post">
                                    <a className="uk-inline" href="https://wpkixx.com/html/socimo/images/elements/image2.jpg" data-fancybox>
                                      <img src="https://wpkixx.com/html/socimo/images/elements/image2.jpg" alt />
                                    </a>
                                  </div>
                                </div>
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="images-post">
                                    <a className="uk-inline" href="https://wpkixx.com/html/socimo/images/elements/image3.jpg" data-fancybox>
                                      <img src="https://wpkixx.com/html/socimo/images/elements/image3.jpg" alt />
                                    </a>
                                  </div>
                                </div>
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="images-post">
                                    <a className="uk-inline" href="https://wpkixx.com/html/socimo/images/elements/image4.jpg" data-fancybox>
                                      <img src="https://wpkixx.com/html/socimo/images/elements/image4.jpg" alt />
                                    </a>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="row merged-10 remove-ext20">
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="video-posts">
                                    <img src="https://wpkixx.com/html/socimo/images/resources/post-video1.jpg" alt />
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="video-posts">
                                    <img src="https://wpkixx.com/html/socimo/images/resources/post-video2.jpg" alt />
                                    <a className="play-btn" data-fancybox href="https://www.youtube.com/watch?v=nOCXXHGMezU&feature=emb_title"><i className="icofont-play" /></a>
                                  </div>
                                </div>
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="video-posts">
                                    <img src="https://wpkixx.com/html/socimo/images/resources/post-video3.jpg" alt />
                                    <a className="play-btn" data-fancybox href="https://www.youtube.com/watch?v=nOCXXHGMezU&feature=emb_title"><i className="icofont-play" /></a>
                                  </div>
                                </div>
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="video-posts">
                                    <img src="https://wpkixx.com/html/socimo/images/resources/post-video4.jpg" alt />
                                    <a className="play-btn" data-fancybox href="https://www.youtube.com/watch?v=nOCXXHGMezU&feature=emb_title"><i className="icofont-play" /></a>
                                  </div>
                                </div>
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="video-posts">
                                    <img src="https://wpkixx.com/html/socimo/images/resources/post-video5.jpg" alt />
                                    <a className="play-btn" data-fancybox href="https://www.youtube.com/watch?v=nOCXXHGMezU&feature=emb_title"><i className="icofont-play" /></a>
                                  </div>
                                </div>
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="video-posts">
                                    <img src="https://wpkixx.com/html/socimo/images/resources/post-video6.jpg" alt />
                                    <a className="play-btn" data-fancybox href="https://www.youtube.com/watch?v=nOCXXHGMezU&feature=emb_title"><i className="icofont-play" /></a>
                                  </div>
                                </div>
                              </div>
                          ...
                          <div className="tab-pane fade" id="members">
                            <div className="main-wraper">
                              <h4 className="main-title">Members (254)</h4>
                          ...
                          <div className="tab-pane fade" id="videos">
                            <div className="main-wraper">
                              ...
                              <div className="row merged-10 remove-ext20">
                                ...
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="video-posts">
                                    <img src="https://wpkixx.com/html/socimo/images/resources/post-video8.jpg" alt />
                                    <a className="play-btn" data-fancybox href="https://www.youtube.com/watch?v=nOCXXHGMezU&feature=emb_title"><i className="icofont-play" /></a>
                                  </div>
                                </div>
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="video-posts">
                                    <img src="https://wpkixx.com/html/socimo/images/resources/post-video9.jpg" alt />
                                    <a className="play-btn" data-fancybox href="https://www.youtube.com/watch?v=nOCXXHGMezU&feature=emb_title"><i className="icofont-play" /></a>
                                  </div>
                                </div>
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="video-posts">
                                    <img src="https://wpkixx.com/html/socimo/images/resources/post-video10.jpg" alt />
                                    <a className="play-btn" data-fancybox href="https://www.youtube.com/watch?v=nOCXXHGMezU&feature=emb_title"><i className="icofont-play" /></a>
                                  </div>
                                </div>
                                <div className="col-lg-4 col-md-4 col-sm-4">
                                  <div className="video-posts">
                                    <img src="https://wpkixx.com/html/socimo/images/resources/post-video11.jpg" alt />
                                    <a className="play-btn" data-fancybox href="https://www.youtube.com/watch?v=nOCXXHGMezU&feature=emb_title"><i className="icofont-play" /></a>
                                  </div>
                                </div>
                                <div className="col-lg-4 col-md-4 col-sm-4">
                              ...
                              <div className="row col-xs-6">
                                <div className="col-lg-3 col-md-4 col-sm-4">
                                  <div className="group-box">
                                    <figure><img alt src="https://wpkixx.com/html/socimo/images/resources/group1.jpg" /></figure>
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-4">
                                  <div className="group-box">
                                    <figure><img src="https://wpkixx.com/html/socimo/images/resources/group2.jpg" alt /></figure>
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-4">
                                  <div className="group-box">
                                    <figure><img src="https://wpkixx.com/html/socimo/images/resources/group3.jpg" alt /></figure>
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-4">
                                  <div className="group-box">
                                    <figure><img src="https://wpkixx.com/html/socimo/images/resources/group4.jpg" alt /></figure>
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-4">
                                  <div className="group-box">
                                    <figure><img src="https://wpkixx.com/html/socimo/images/resources/group5.jpg" alt /></figure>
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-4">
                                  <div className="group-box">
                                    <figure><img src="https://wpkixx.com/html/socimo/images/resources/group6.jpg" alt /></figure>
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-4">
                                  <div className="group-box">
                                    <figure><img src="https://wpkixx.com/html/socimo/images/resources/group7.jpg" alt /></figure>
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-4">
                                  <div className="group-box">
                                    <figure><img src="https://wpkixx.com/html/socimo/images/resources/group8.jpg" alt /></figure>
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-4">
                                  <div className="group-box">
                                    <figure><img src="https://wpkixx.com/html/socimo/images/resources/group9.jpg" alt /></figure>
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-4">
                                  <div className="group-box">
                                    <figure><img src="https://wpkixx.com/html/socimo/images/resources/group10.jpg" alt /></figure>
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-4">
                                  <div className="group-box">
                                    <figure><img src="https://wpkixx.com/html/socimo/images/resources/group11.jpg" alt /></figure>
