            ...
            <div className="col-lg-12">
              <div id="page-contents" className="row merged20">
                <div className="col-lg-9">
                  <div className="main-wraper">
                    ...
                    <div className="row col-xs-6">
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-6">
                        <div className="book-post">
                          <figure><a href="book-detail.html" title><img src="https://wpkixx.com/html/socimo/images/resources/book6.jpg" alt /></a></figure>
                          <a href="book-detail.html" title>VU.js experts</a>
                        </div>
                      </div>
                      <div className="col-lg-6 col-md-6 col-sm-6">
                        <div className="book-post">
                          <figure><a href="book-detail.html" title><img src="https://wpkixx.com/html/socimo/images/resources/book7.jpg" alt /></a></figure>
                      ...
                      <div className="col-lg-3 col-md-3 col-sm-6">
                        <div className="book-post">
                          <figure><a href="book-detail.html" title><img src="https://wpkixx.com/html/socimo/images/resources/book8.jpg" alt /></a></figure>
                          <a href="book-detail.html" title>PHP for Bigners</a>
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-3 col-sm-6">
                        <div className="book-post">
                          <figure><a href="book-detail.html" title><img src="https://wpkixx.com/html/socimo/images/resources/book9.jpg" alt /></a></figure>
                          <a href="book-detail.html" title>Css3 for Bigners</a>
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-3 col-sm-6">
                        <div className="book-post">
                          <figure><a href="book-detail.html" title><img src="https://wpkixx.com/html/socimo/images/resources/book10.jpg" alt /></a></figure>
                          <a href="book-detail.html" title>VU.js2 Bingers</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="load mb-5 mt-1">
                  ...
                  <div className="main-wraper">
                    <h4 className="main-title">Categories <a className="view-all" href="#" title>view all</a></h4>
