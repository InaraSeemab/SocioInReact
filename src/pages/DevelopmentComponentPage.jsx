                      ...
                      <ul className="uk-switcher pl-lg-3" id="components-nav">
                        ...
                        <li>
                          <div className="mt-4 uk-grid-large" uk-grid>
                            <div className="uk-width-3-4@s">
                              ...
                              <div uk-filter="target: .js-filter">
                                <ul className="uk-subnav uk-subnav-pill">
                                  <li uk-filter-control=".tag-white">< Link to="#">White</Link></li>
                                  <li uk-filter-control=".tag-blue">< Link to="#">Blue</Link></li>
                                  <li uk-filter-control=".tag-black">< Link to="#">Black</Link></li>
                                </ul>
                              ...
                              <p>The Filter component comes unstyled, which allows you to use any of the other UIkit
                                components to create the filter controls and layout items. For example, the <Link to="https://wpkixx.com/html/socimo/tabs.html">Tab</Link> components can
                                be used to style the filter controls. Usually, the <Link to="https://wpkixx.com/html/socimo/grid.html">Grid
                                  component</Link> is used
                              ...
                              <div uk-filter="target: .js-filter">
                                <ul className="uk-subnav uk-subnav-pill">
                                  <li className="uk-active" uk-filter-control="[data-color='white']"><Link to="#">White</Link> </li>
                                  <li uk-filter-control="[data-color='blue']"><Link to="#">Blue</Link></li>
                                  <li uk-filter-control="[data-color='black']"><Link to="#">Black</Link></li>
                                </ul>
                                <ul className="js-filter uk-child-width-1-2 uk-child-width-1-3@m uk-text-center" uk-grid>
                                  <li data-color="white">
                                    <div className="uk-card uk-card-default uk-card-body">Item</div>
                              ...
                              <div uk-filter="target: .js-filter">
                                <ul className="uk-subnav uk-subnav-pill">
                                  <li className="uk-active" uk-filter-control><Link to="#">All</Link></li>
                                  <li uk-filter-control="[data-color='white']"><Link to="#">White</Link></li>
                                  <li uk-filter-control="[data-color='blue']"><Link to="#">Blue</Link></li>
                                  <li uk-filter-control="[data-color='black']"><Link to="#">Black</Link></li>
                                </ul>
                                <ul className="js-filter uk-child-width-1-2 uk-child-width-1-3@m uk-text-center" uk-grid>
                              ...
                              <div uk-filter="target: .js-filter">
                                <ul className="uk-subnav uk-subnav-pill">
                                  <li uk-filter-control="[data-tags*='white']"><Link to="#">White</Link></li>
                                  <li uk-filter-control="[data-tags*='blue']"><Link to="#">Blue</Link></li>
                                  <li uk-filter-control="[data-tags*='black']"><Link to="#">Black</Link></li>
                                  <li uk-filter-control="[data-tags*='dark']"><Link to="#">Dark Colors</Link></li>
                                </ul>
                                <ul className="js-filter uk-child-width-1-2 uk-child-width-1-3@m uk-text-center" uk-grid>
                                  <li data-tags="white">
                                    <div className="uk-card uk-card-default uk-card-body">Item</div>
                              ...
                              <div uk-filter="target: .js-filter">
                                <div className="uk-grid-small uk-grid-divider uk-child-width-auto" uk-grid>
                                  ...
                                  <div>
                                    <ul className="uk-subnav uk-subnav-pill" uk-margin>
                                      <li uk-filter-control="[data-size='small']"><Link to="#">Small</Link></li>
                                      <li uk-filter-control="[data-size='medium']"><Link to="#">Medium</Link></li>
                                      <li uk-filter-control="[data-size='large']"><Link to="#">Large</Link></li>
                                    </ul>
                                  </div>
                                </div>
                              ...
                              <div uk-filter="target: .js-filter">
                                <div className="uk-grid-small uk-grid-divider uk-child-width-auto" uk-grid>
                                  ...
                                  <div>
                                    <ul className="uk-subnav uk-subnav-pill" uk-margin>
                                      <li uk-filter-control="filter: [data-color='white']; group: data-color"> <Link to="#">White</Link></li>
                                      <li uk-filter-control="filter: [data-color='blue']; group: data-color"> <Link to="#">Blue</Link></li>
                                      <li uk-filter-control="filter: [data-color='black']; group: data-color"> <Link to="#">Black</Link></li>
                                    </ul>
                                  </div>
                                  <div>
                                    <ul className="uk-subnav uk-subnav-pill" uk-margin>
                                      <li uk-filter-control="filter: [data-size='small']; group: size"><Link to="#">Small</Link> </li>
                                      <li uk-filter-control="filter: [data-size='medium']; group: size"><Link to="#">Medium</Link> </li>
                                      <li uk-filter-control="filter: [data-size='large']; group: size"><Link to="#">Large</Link> </li>
                                    </ul>
                                  </div>
                                </div>
                                <ul className="js-filter uk-child-width-1-2 uk-child-width-1-3@m uk-text-center" uk-grid="masonry: true">
                            ...
                            <div className="uk-width-1-4@s  uk-visible@s">
                              <ul className="uk-list docs-list" uk-sticky="offset:100;media : @m; top:20">
                                <li> <Link to="#filter-introductions" uk-scroll> Introduction </Link></li>
                                <li> <Link to="#Active-state" uk-scroll> Active state </Link></li>
                                <li> <Link to="#Reset-filter" uk-scroll> Reset filter </Link></li>
                                <li> <Link to="#Meta-Data" uk-scroll> Meta Data </Link></li>
                                <li> <Link to="#Multiple-Filters" uk-scroll> Multiple-Filters </Link></li>
                                <li> <Link to="#Groups" uk-scroll> Groups </Link></li>
                              </ul>
                            </div>
                          </div>
                        </li>
                        ...
                        <li>
                          <div className="mt-4 uk-grid-large" uk-grid>
                            <div className="uk-width-3-4@s">
                              ...
                              <h6> PREVIEW</h6>
                              <div uk-lightbox> <Link className="button uk-button-default" href="https://wpkixx.com/html/socimo/images/elements/dark.jpg">Open
                                Lightbox</Link> </div>
                              <div>
                              ...
                              <p>To display a caption at the bottom of the lightbox, set the <code> data-caption</code> attribute
                                on an anchor.</p>
                              <h6> PREVIEW</h6>
                              <div uk-lightbox> <Link className="button uk-button-default" href="https://wpkixx.com/html/socimo/images/elements/light.jpg" data-caption="Caption">Open Lightbox </a> </div>
                              <div>
                              ...
                              <h6> PREVIEW</h6>
                              <div uk-lightbox> <Link className="button uk-button-default" to="https://wpkixx.com/html/socimo/images/elements/dark.jpg" data-caption="Image">Image</Link> <Link className="button uk-button-default" to="https://www.youtube.com/watch?v=YE7VzlLtp-4" data-caption="Video">Video</Link> <Link className="button uk-button-default" to="https://www.youtube.com/watch?v=YE7VzlLtp-4" data-caption="YouTube">YouTube</Link> <Link className="button uk-button-default" to="https://vimeo.com/1084537" data-caption="Vimeo">Vimeo</Link> <Link className="button uk-button-default" to="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4740.819266853735!2d9.99008871708242!3d53.550454675412404!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x3f9d24afe84a0263!2sRathaus!5e0!3m2!1sde!2sde!4v1499675200938" data-caption="Google Maps" data-type="iframe">Google Maps</Link> </div>
                              <div>
                              ...
                              <div className="uk-child-width-1-3@m" uk-grid uk-lightbox="animation: slide">
                                <div> <Link className="uk-inline" to="https://wpkixx.com/html/socimo/images/elements/light.jpg" data-caption="Caption 1"> <img src="https://wpkixx.com/html/socimo/images/elements/light.jpg" alt /> </Link> </div>
                                <div> <Link className="uk-inline" to="https://wpkixx.com/html/socimo/images/elements/dark.jpg" data-caption="Caption 2"> <img src="https://wpkixx.com/html/socimo/images/elements/dark.jpg" alt /> </Link> </div>
                                <div> <Link className="uk-inline" to="https://wpkixx.com/html/socimo/images/elements/image.jpg" data-caption="Caption 3"> <img src="https://wpkixx.com/html/socimo/images/elements/image.jpg" alt /> </Link> </div>
                              </div>
                            ...
                            <div className="uk-width-1-4@s uk-visible@s">
                              <ul className="uk-list docs-list" uk-sticky="offset:100;media : @m; top:20">
                                <li> <Link to="#Introd" uk-scroll> Introduction </Link></li>
                                <li> <Link to="#Caption" uk-scroll> Caption </Link></li>
                                <li> <Link to="#Content-sources" uk-scroll> Content sources </Link></li>
                                <li> <Link to="#animtn" uk-scroll> Animation </Link></li>
                              </ul>
                            </div>
                          </div>
                        </li>
                        ...
                        <li>
                          <div className="mt-4 uk-grid-large" uk-grid>
                            <div className="uk-width-3-4@s">
                              ...
                              <Link to="#modal-example" uk-toggle>Open</Link>
                              {/* This is the modal */}
                              ...
                              <Link className="button uk-button-default" to="#modal-center" uk-toggle>Open</Link>
                              <div id="modal-center" className="uk-flex-top" uk-modal>
                                <div className="uk-modal-dialog uk-modal-body uk-margin-auto-
                            ...
                            <p> To divide the modal into different content sections, use the
                              following classes. </p>
                            <Link className="button uk-button-default" to="#modal-sections" uk-toggle>Open</Link>
                            ...
                            <h6> PREVIEW</h6>
                            <p uk-margin> <Link className="button uk-button-default" to="#modal-group-1" uk-toggle>Modal 1</Link> <Link className="button uk-button-default" to="#modal-group-2" uk-toggle>Modal 2</Link> </p>
                            <div id="modal-group-1" uk-modal>
                              <div className="uk-modal-dialog">
                                ...
                                <div className="uk-modal-footer uk-text-right">
                                  <button className="button uk-button-default uk-modal-close" type="button">Cancel</button>
                                  <Link to="#modal-group-2" className="button uk-button-primary" uk-toggle>Next</Link> </div>
                              </div>
                            </div>
                            <div id="modal-group-2" uk-modal>
                              <div className="uk-modal-dialog">
                                ...
                                <div className="uk-modal-footer uk-text-right">
                                  <button className="button uk-button-default uk-modal-close" type="button">Cancel</button>
                                  <Link to="#modal-group-1" className="button uk-button-primary" uk-toggle>Previous</Link> </div>
                              </div>
                            </div>
                            <div>
                            ...
                            <p><span className="uk-label">Note</span> Use the <code>uk-video</code> attribute from the <Link to="/video">Video component</Link> to make sure videos
                              are stopped when the modal is closed.</p>
                            <h6> PREVIEW</h6>
                            <p uk-margin> <Link className="button uk-button-default" to="#modal-media-image" uk-toggle>Image</Link> <Link className="button uk-button-default" to="#modal-media-video" uk-toggle>Video</Link> <Link className="button uk-button-default" to="#modal-media-youtube" uk-toggle>YouTube</Link> <Link className="button uk-button-default" to="#modal-media-vimeo" uk-toggle>Vimeo</Link> </p>
                            ...
                            <p>Using the <Link to="https://wpkixx.com/html/socimo/grid.html">grid</Link> and width classes, you can create a nice,
                              split fullscreen modal.</p>
                            <Link className="button uk-button-default" to="#modal-full" uk-toggle>Open</Link>
                            ...
                            <Link className="button uk-button-default" to="#modal-overflow" uk-toggle>Open</Link>
                          ...
                          <div className="uk-width-1-4@s uk-visible@s">
                            <ul className="uk-list docs-list" uk-sticky="offset:100;media : @m; top:20">
                              <li> <Link to="#modal-intro" uk-scroll> Introduction </Link></li>
                              <li> <Link to="#Close-btn" uk-scroll> Close button </Link></li>
                              <li> <Link to="#Center-modal" uk-scroll> Center modal </Link></li>
                              <li> <Link to="#Header-and-footer" uk-scroll> Header and footer </Link></li>
                              <li> <Link to="#Group-modifiers" uk-scroll> Group modifiers </Link></li>
                              <li> <Link to="#Media" uk-scroll> Media </Link></li>
                              <li> <Link to="#Full-modifier" uk-scroll> Full modifier </Link></li>
                              <li> <Link to="#Overflow" uk-scroll> Overflow </Link></li>
                              <li> <Link to="#Position" uk-scroll> Position content </Link></li>
                            </ul>
                          </div>
                        </div>
                      </li>
                        ...
                        <div className="mt-4 uk-grid-large" uk-grid>
                          <div className="uk-width-3-4@s">
                            ...
                            <div className="uk-position-relative uk-visible-toggle uk-light" tabIndex={-1} uk-slider>
                              ...
                              <Link className="uk-position-center-left uk-position-small uk-hidden-hover" to="#" uk-slidenav-previous uk-slider-item="previous" /> <Link className="uk-position-center-right uk-position-small uk-hidden-hover" to="#" uk-slidenav-next uk-slider-item="next" /> </div>
                            <div>
                            ...
                            <p>To apply a gutter to the slider items, use the <Link to="http://demo.foxthemes.net/elements/grid.html">Grid
                          ...
                          <div className="uk-width-1-4@s uk-visible@s">
                            <ul className="uk-list docs-list" uk-sticky="offset:100;media : @m; top:20">
                              <li> <Link to="#slider-intro" uk-scroll> Basic </Link></li>
                              <li> <Link to="#Gutter" uk-scroll> Gutter </Link></li>
                              <li> <Link to="#Center" uk-scroll> Center </Link></li>
                              <li> <Link to="#slider-Set" uk-scroll> Slide-Sets </Link></li>
                              <li> <Link to="#slide-nav" uk-scroll> Navigation </Link></li>
                              <li> <Link to="#Toggle" uk-scroll> Toggle </Link></li>
                            </ul>
                          </div>
                        </div>
                      </li>
