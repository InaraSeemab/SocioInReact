            ...
            <div className="col-lg-12">
              <div id="page-contents" className="row merged20">
                    ...
                    <div className="widget">
                      ...
                      <div className="popular-book">
                        ...
                        <div className="book-about">
                          ...
                          <a href="#" title><i className="icofont-book-mark" /></a>
                        </div>
                      </div>
                      <div className="popular-book">
                ...
                <div className="col-lg-9">
                  <ul className="nav nav-tabs about-btn mb-4">
                    <li className="nav-item"><a className="active" href="#posts" data-toggle="tab">All</a></li>
                    <li className="nav-item"><a className href="#pictures" data-toggle="tab">Today</a></li>
                    <li className="nav-item"><a className href="#videos" data-toggle="tab">Tomorrow</a></li>
                    <li className="nav-item"><a className href="#videos" data-toggle="tab">This Week</a></li>
                    <li className="nav-item"><a className href="#videos" data-toggle="tab">This weekend</a></li>
                    <li className="nav-item"><a className href="#videos" data-toggle="tab">Next Week</a></li>
                  </ul>
                  <div className="main-wraper">
                    <div className="main-title">Browse Events</div>
                    <ul className="event-browse">
                      <li className="red">
                  ...
                  <div className="main-wraper">
                    <div className="main-title">Daily Recommendations</div>
                    <div className="row">
                      <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="event-post mb-3">
                          <figure><a href="event-detail.html" title><img src="https://wpkixx.com/html/socimo/images/resources/event-post1.jpg" alt /></a></figure>
                          <div className="event-meta">
                            <span>Happening Now</span>
                            <h6><a href="event-detail.html" title>Exhibition of Music</a></h6>
                            <p>Some description about the event write here.</p>
                            <a className="classic-btn" href="#" title>Interested</a>
                            <div className="more">
                              <div className="more-post-optns">
                                ...
                                <ul>
                                  <li>
                                    <i className="icofont-share-alt" />Share to Feed
                                    <span>Share This Post to Friends</span>
                                  </li>
                                  <li>
                                    <i className="icofont-ui-text-chat" />Send Message
                      ...
                      <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="event-post mb-3">
                          <figure><a href="event-detail.html" title><img src="https://wpkixx.com/html/socimo/images/resources/event-post2.jpg" alt /></a></figure>
                          <div className="event-meta">
                      ...
                      <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="event-post mb-3">
                          <figure><a href="event-detail.html" title><img src="https://wpkixx.com/html/socimo/images/resources/event-post3.jpg" alt /></a></figure>
                          <div className="event-meta">
                      ...
                      <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="event-post mb-3">
                          <figure><a href="event-detail.html" title><img src="https://wpkixx.com/html/socimo/images/resources/event-post4.jpg" alt /></a></figure>
                          <div className="event-meta">
                      ...
                      <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="event-post mb-3">
                          <figure><a href="event-detail.html" title><img src="https://wpkixx.com/html/socimo/images/resources/event-post5.jpg" alt /></a></figure>
                          <div className="event-meta">
                      ...
                      <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="event-post mb-3">
                          <figure><a href="event-detail.html" title><img src="https://wpkixx.com/html/socimo/images/resources/event-post6.jpg" alt /></a></figure>
                          <div className="event-meta">
                      ...
                      <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="event-post mb-3">
                          <figure><a href="event-detail.html" title><img src="https://wpkixx.com/html/socimo/images/resources/event-post7.jpg" alt /></a></figure>
                          <div className="event-meta">
