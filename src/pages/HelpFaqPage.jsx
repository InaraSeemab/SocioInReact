    ...
    <>
      ...
      <div>
        <div className="theme-layout">
          ...
          <section>
            <div className="gap no-bottom help-bg">
              <div className="container">
                <div className="row">
                  <div className="col-lg-12">
                    <div className="search-section">
                      <a href="#" title><i className="icofont-home" /> Back to Home</a>
              ...
              <figure className="bottom-image"><img src="https://wpkixx.com/html/socimo/images/bg-4.png" alt /></figure>
            </div>
          </section>
          <section>
            <div className="gap">
                ...
                <div className="row" id="page-contents">
                  <div className="col-lg-9">
                    <div className="main-wraper">
                      <h4 className="main-title">Brows Help Topics</h4>
                      <div className="row col-xs-6">
                        <div className="col-lg-4 col-md-4 col-sm-4">
                          <div className="help-topic">
                            <span><i className="icofont-gears" /></span>
                            <a href="#" title>Your Account Settings</a>
                          </div>
                        </div>
                        <div className="col-lg-4 col-md-4 col-sm-4">
                          <div className="help-topic">
                            <span><i className="icofont-legal" /></span>
                            <a href="#" title>Legal &amp; Privacy</a>
                          </div>
                        </div>
                        <div className="col-lg-4 col-md-4 col-sm-4">
                          <div className="help-topic">
                            <span><i className="icofont-building" /></span>
                            <a href="#" title>Business &amp; Websites</a>
                          </div>
                        </div>
                        <div className="col-lg-4 col-md-4 col-sm-4">
                          <div className="help-topic">
                            <span><i className="icofont-fix-tools" /></span>
                            <a href="#" title>Fix a Problem</a>
                          </div>
                        </div>
                        <div className="col-lg-4 col-md-4 col-sm-4">
                          <div className="help-topic">
                            <span><i className="icofont-safety" /></span>
                            <a href="#" title>Safety &amp; Standards</a>
                          </div>
                        </div>
                        <div className="col-lg-4 col-md-4 col-sm-4">
                          <div className="help-topic">
                            <span><i className="icofont-shopify" /></span>
                    ...
                    <div className="main-wraper">
                      <h4 className="main-title">FAQ'S</h4>
                      <p>
                        <i className="icofont-question-circle" /> What are you struggling right now, what we can help with?
                      </p>
