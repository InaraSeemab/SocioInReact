              ...
              <div id="page-contents" className="row merged20">
                <div className="col-lg-9">
                  <div className="main-wraper">
                    <h4 className="main-title">Amazon FBA Mastery Follow up!</h4>
                    <figure className="event-detail-img"><img src="https://wpkixx.com/html/socimo/images/resources/event-detail.jpg" alt /></figure>
                    <div className="event-schedule">
                      <h6>schedule</h6>
                      <span>Next date of your event</span>
                      <h5><i className>
                          <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="feather feather-calendar"><rect x={3} y={4} width={18} height={18} rx={2} ry={2} /><line x1={16} y1={2} x2={16} y2={6} /><line x1={8} y1={2} x2={8} y2={6} /><line x1={3} y1={10} x2={21} y2={10} /></svg></i> Friday, July 15, 2021 at <b>3:45PM</b> GMT+5:30</h5>
                      <a href="#" title>Edit</a>
                      <a className="invite-co" href="#" title><i className="icofont-user-alt-1" /> Invite Co-pesenters &amp; Moderators</a>
                    </div>
                    <div className="event-desc">
                      ...
                      <h6>Event Website</h6>
                      <em><a href="#" title>https://www.sample.com/event</a></em>
                    </div>
                    <div className="event-loc">
                      <h6>Event Location</h6>
                      <span><i className="icofont-map-pins" /> 150 garden town, street 24 ontatio, Canada</span>
                      <div className="g-mapfull" style={{height: 400, width: '100%'}}>
                        <div id="map-canvas" />
                      </div>
                      <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-6">
                          <figure><img alt src="https://wpkixx.com/html/socimo/images/resources/event-small.jpg" /></figure>
                        </div>
                        <div className="col-lg-6 col-md-6 col-sm-6">
                          <figure><img alt src="https://wpkixx.com/html/socimo/images/resources/event-small2.jpg" /></figure>
                        </div>
                      </div>
                      <p>
                        Moms are the ones who bandage our boo-boos when we’re little and continue to take care of us as we get older—often sacrificing their own needs so they can help with ours. Cruising on a bike to help heal our injuries is the most mom thing one can do.
                      </p>
                      <strong>365 peoples has reached to join this event.</strong>
                      <a href="#" title className="main-btn">Join Now <i className="icofont-arrow-right" /></a>
                    </div>
                  </div>
                </div>
