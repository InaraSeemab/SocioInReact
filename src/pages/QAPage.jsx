            ...
            <div className="col-lg-12">
              <div id="page-contents" className="row merged20">
                <div className="col-lg-9">
                  ...
                  <div className="main-wraper">
                    <div className="friend-info">
                      <h2 className="question-title"><a href="#" title>What's a mutation observer?</a></h2>
                      <div className="more">
                      ...
                      <div className="friend-name">
                        <ins><a href="https://wpkixx.com/html/socimo/time-line.html" title>Maria k.</a> added a chapter</ins>
                      ...
                      <div className="question-meta">
                        ...
                        <a href="#" title className="main-btn">view Answers</a>
                      </div>	
                    </div>
                  </div>
                  <div className="main-wraper">
                    <div className="friend-info">
                      <h2 className="question-title"><a href="#" title>Is there a simple guide for Sass Mixins?</a></h2>
                      <div className="more">
                        <div className="more-post-optns">
                          <i className>
                            <svg className="feather feather-more-horizontal" strokeLinejoin="round" strokeLinecap="round" strokeWidth={2} stroke="currentColor" fill="none" viewBox="0 0 24 24" height={24} width={24} xmlns="http://www.w3.org/2000/svg"><circle r={1} cy={12} cx={12} /><circle r={1} cy={12} cx={19} /><circle r={1} cy={12} cx={5} /></svg></i>
                      ...
                      <div className="friend-name">
                        <ins><a href="https://wpkixx.com/html/socimo/time-line.html" title>Fawad Khan</a> added a chapter</ins>
                        <span><i className="icofont-globe" /> published: Sep,15 2020</span>
                      </div>
                      <div className="question-meta">
                        <p>
                  ...
                  <div className="main-wraper">
                    <div className="friend-info">
                      <h2 className="question-title"><a href="#" title>Is React compatible with jQuery?</a></h2>
                      <div className="more">
                        <div className="more-post-optns">
                          <i className>
                            <svg className="feather feather-more-horizontal" strokeLinejoin="round" strokeLinecap="round" strokeWidth={2} stroke="currentColor" fill="none" viewBox="0 0 24 24" height={24} width={24} xmlns="http://www.w3.org/2000/svg"><circle r={1} cy={12} cx={12} /><circle r={1} cy={12} cx={19} /><circle r={1} cy={12} cx={5} /></svg></i>
                      ...
                      <div className="friend-name">
                        <ins><a href="https://wpkixx.com/html/socimo/time-line.html" title>Danial Cardos</a> added a chapter</ins>
                        <span><i className="icofont-globe" /> published: Sep,15 2020</span>
                      </div>
                      <div className="question-meta">
                        <p>
                ...
                <div className="col-lg-3">
                  <aside className="sidebar static right mt-5">
