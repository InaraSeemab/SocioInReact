                ...
                <div className="col-lg-9">
                  <div className="group-feed">
                    <div className="group-avatar">
                      <img src="https://wpkixx.com/html/socimo/images/resources/group-profile.jpg" alt />
                      <a href="#" title><i className="icofont-check-circled" />Joined</a>
                      <figure className="group-dp"><img src="https://wpkixx.com/html/socimo/images/resources/group-dp.jpg" alt /></figure>
                    </div>
                        ...
                        <aside className="sidebar static left">
                          ...
                          <div className="widget">
                            ...
                            <div className="recent-media">
                              ...
                              <figure>
                                <img alt src="https://wpkixx.com/html/socimo/images/resources/course-4.jpg" />
                                <a href="https://www.youtube.com/watch?v=nOCXXHGMezU&feature=emb_title" data-fancybox className="play-btn"><i className="icofont-play" /></a>
