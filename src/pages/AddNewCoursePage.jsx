          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              <div className="main-wraper">
                <h4 className="main-title">Add New Course or Book</h4>
                <h6 className="mb-4">Add new course and book for sale in the <b>Socimo</b> Market Place</h6>
                <div className="add-credits">
                  <form>
                    <fieldset className="row merged-10">
                      <div className="mb-4 col-lg-6 col-md-6 col-sm-6">
                        <input className="uk-input" type="text" placeholder="Course Title" />
                      </div>
                      <div className="mb-4 col-lg-6 col-md-6 col-sm-6">
                        <input className="uk-input" type="text" placeholder="Course Subtitle" />
                      </div>
                      <div className="uk-margin col-lg-4 mb-4">
                      ...
                      <div className="mb-4 col-lg-12">
                        <textarea placeholder="Textarea" rows={4} className="uk-textarea" defaultValue={""} />
                      </div>
                  ...
                  <div className="mt-3 col-lg-12">
                    <button type="submit" className="button primary circle">Publish</button>
                  </div>
                  <p>
                    <b>Special Note:</b>
