...
export default function QdetailPage() {
  return (
    <>
      <div>
              ...
              <div id="page-contents" className="row merged20">
                <div className="col-lg-9">
                  ...
                  <div className="main-wraper">
                    ...
                    <div className="anser">
                      <i className="icofont-check-circled" title="Best Answer" />
                      <div className="friend-info">
                        <div className="more">
                          <div className="more-post-optns">
                            <i className>
                        ...
                        <div className="question-meta">
                          ...
                          <a href="#" title className="main-btn">vote 25</a>
                        </div>	
                      </div>
                      <div className="friend-info">
                        <div className="more">
                        ...
                        <div className="question-meta">
                          ...
                          <a href="#" title className="main-btn">vote 20</a>
                        </div>	
                      </div>
                    </div>	
                  </div>
                  <div className="main-wraper">
                    <h4 className="main-title">Related Questions</h4>
                    <ul className="related-qst">
                      <li>
