...
export default function privacynpolicyPage() {
  return (
    <>
      <div>
            ...
            <div className="col-lg-3">
              <nav className="responsive-tab style-4 mb-4">
                <ul className="nav nav-tabs uk-list">
                  <li className="nav-item"><a className="active" href="#pricing" data-toggle="tab">Pricing Policy</a></li>
                  <li className="nav-item"><a className href="#privacy" data-toggle="tab">Company Privacy</a></li>
                  <li className="nav-item"><a className href="#terms" data-toggle="tab">Terms &amp; Conditions</a></li>
                  <li className="nav-item"><a className href="#policy" data-toggle="tab">Copyright Policy</a></li>
                </ul>
              </nav>	
            </div>	
            {/* Tab panes */}
            <div className="col-lg-9">
              <div className="main-wraper">
                <div className="tab-content" id="components-nav">
                  <div className="tab-pane active fade show" id="pricing">
                    <h2>Pricing and Payout</h2>
                    <span className>Our Priciing Policy is updated on <b>December 10, 2021</b></span>
                    <div className="mt-4">
                      ...
                      <div className="billing-percen">
                        <div className="billing-percent-bar">
                          <ul className="progress-bar-labels">
                            <li>
                              <div className="label_zero-level">
                                <span className="progress-bar__profit">
                                  <strong className="format-currency ">$0</strong>
                                </span>
                                <span className="billing-percentages-progress-bar__percent t5">50%</span>
                              </div>
                            </li>
                            <li>
                              <div className="billing-percentages-progress-bar__label">
                                ...
                                <span className="billing-percentages-progress-bar__percent t5">53%</span>
                              </div>
                            </li>
                            <li>
                              <div className="billing-percentages-progress-bar__label">
                                <span className="progress-bar__profit t5">
                                  <strong className="format-currency ">$8,000</strong>
                                </span>
                                <span className="billing-percentages-progress-bar__percent t5">55%</span>
                              </div>
                            </li>
                            <li>
                              <div className="billing-percentages-progress-bar__label">
                                ...
                                <span className="billing-percentages-progress-bar__percent t5">58%</span>
                              </div>
                            </li>
                            <li>
                              <div className="billing-percentages-progress-bar__label">
                                ...
                                <span className="billing-percentages-progress-bar__percent t5">62%</span>
                              </div>
                            </li>
                            <li>
                              <div className="billing-percentages-progress-bar__label">
                                ...
                                <span className="billing-percentages-progress-bar__percent t5">70%</span>
                              </div>
                            </li>
                            <li>
                              <div className="billing-percentages-progress-bar__label">
                                ...
                                <span className="billing-percentages-progress-bar__percent t5">80%</span>
                              </div>
                            </li>
                          </ul>
                        </div>
                        ...
                        <ul className="progress-bar-labels">
                          <li>
                            <div className="label_zero-level">
                              ...
                              <span className="billing-percentages-progress-bar__percent t5">30%</span>
                            </div>
                          </li>
                          <li>
                            <div className="billing-percentages-progress-bar__label">
                              ...
                              <span className="billing-percentages-progress-bar__percent t5">32%</span>
                            </div>
                          </li>
                          <li>
                            <div className="billing-percentages-progress-bar__label">
                              ...
                              <span className="billing-percentages-progress-bar__percent t5">35%</span>
                            </div>
                          </li>
                          <li>
                            <div className="billing-percentages-progress-bar__label">
                              ...
                              <span className="billing-percentages-progress-bar__percent t5">40%</span>
                            </div>
                          </li>
                          <li>
                            <div className="billing-percentages-progress-bar__label">
                              ...
                              <span className="billing-percentages-progress-bar__percent t5">45%</span>
                            </div>
                          </li>
                          <li>
                            <div className="billing-percentages-progress-bar__label">
                  ...
                  <div className="tab-pane fade" id="privacy">
                    <h2>Terms of Use</h2>
                    <span className>These terms of use were last updated on <b>December 10, 2021</b></span>
                    <p className="mt-4">
                    ...
                    <ol className="mb-4">
                      <li><a href="#" title>Socimo Accounts</a></li>
                      <li><a href="#" title>Socimo Pricing</a></li>
                      <li><a href="#" title>Copyrights 2020</a></li>
                      <li><a href="#" title>How to contact</a></li>
                      <li><a href="#" title>Live Chat</a></li>
                      <li><a href="#" title>Socimo Rules &amp; Regulations</a></li>
                    </ol>
                    <p>
                      Nam a egestas libero, eget eleifend turpis. Sed id ipsum a ipsum aliquam laoreet sit amet sit amet nibh. Proin dapibus, libero sed posuere rhoncus, orci mi cursus enim, at accumsan eros massa lacinia mi. Nunc eget finibus felis, volutpat malesuada sem.
                    </p>
                    <p>
                  ...
                  <div className="tab-pane fade" id="policy">
                    <h2>© Copyright 2021 Policy</h2>
                    <span className>Socimo copyright of use were last updated on <b>December 10, 2021</b></span>
                    <p className="mt-4">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur volutpat maximus pellentesque. Integer sem enim, luctus at nibh at, condimentum sagittis sapien. Sed tempus ipsum erat, sit amet efficitur velit interdum eu. Vestibulum hendrerit id dolor eu scelerisque. Phasellus ex dui, consequat nec feugiat eu, dapibus eget ante. Sed sodales interdum dui, at euismod mi feugiat hendrerit. Suspendisse auctor libero in tempor mollis. Nulla et dolor velit. Aliquam sit amet luctus quam.
                    </p>
                  </div>
