              ...
              <div id="page-contents" className="row">
                <div className="col-lg-8">
                  <div className="main-wraper">
                    <h4 className="main-title"><i className="icofont-bill" /> Billing Detail</h4>
                    <div className="billing">
                      <form>
                        <div className="row">
                          ...
                          <div className="col-lg-6 col-md-6 col-sm-12 mb-4">
                            <input className="uk-input" type="text" placeholder="Zip/Postal Code" />
                          </div>
                          <div className="col-lg-12 col-md-12 col-sm-12 mb-4">
                            <textarea className="uk-textarea" rows={5} placeholder="Special Note" defaultValue={""} />
                          </div>
                        </div>
                      </form>
                      ...
                      <div className="courier-option">
                        ...
                        <div className="courier-box">
                          ...
                          <img src="https://wpkixx.com/html/socimo/images/fedex.png" alt />
                          <p>
                        ...
                        <div className="courier-box">
                          <input type="radio" name="courier" />
                          <img src="https://wpkixx.com/html/socimo/images/dhl.png" alt />
                          <p>
                            you can still count on the days and time, your's shipment arrive in 2-3 days shipping.
                          </p>
                        </div>
                ...
                <div className="col-lg-4">
                  <div className="main-wraper stick-widget">
                    <div className="cart-summary">
                      <h4 className="main-title"><i className="icofont-cart-alt" /> Cart Summary</h4>
                      <ul>
                        <li>
                          <div>
                      ...
                      <a className="main-btn purchase-btn" href="#" title>Place Order</a>
                    </div>
                    <div className="useful-info">
                      <ul>
                        <li>
                          <figure><img src="https://wpkixx.com/html/socimo/images/box-icon1.png" alt /></figure>
                        ...
                        <li>
                          <figure><img src="https://wpkixx.com/html/socimo/images/box-icon2.png" alt /></figure>
                          <div className="info-tag">
