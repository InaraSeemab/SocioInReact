            ...
            <div className="col-lg-8">
              <div className="main-wraper">
                <div className="feedback-form">
                  <h4 className="text-center"><i className="icofont-comment" /> Send Feedback</h4>
                  <form className="mt-4">
                    <fieldset className="row">
                      ...
                      <div className="mb-4 uk-margin col-lg-12">
                      ...
                      <div className="mb-4 col-lg-6">
                        <input className="uk-input" type="text" placeholder="University" />
                      </div>
                      ...
                      <div className="mb-4 col-lg-12">
                        <div className="form-group1 mt-30">
                          ...
                          <div className="image-upload-wrap">
                            <input type="file" accept="image/*" onchange="readURL(this);" id="file5" className="file-upload-input" />
                      ...
                      <div className="mb-4 col-lg-12">
                        <div className="feed-back-emojies">
                          <span>How was your experience with Socimo</span>
                          <ul>
                            <li><a href="#" title><img src="https://wpkixx.com/html/socimo/images/smiles/happy.png" alt /></a></li>
                            <li><a href="#" title><img src="https://wpkixx.com/html/socimo/images/smiles/quiet.png" alt /></a></li>
                            <li><a className="selected" href="#" title><img src="https://wpkixx.com/html/socimo/images/smiles/in-love.png" alt /></a></li>
                            <li><a href="#" title><img src="https://wpkixx.com/html/socimo/images/smiles/unhappy.png" alt /></a></li>
                          </ul>
                        </div>
                      </div>
                      <div className="mb-0 col-lg-12 text-center">
                        <button type="submit" className="main-btn">Send Your Feedback</button>
                      </div>	
                    </fieldset>
                  </form>
                </div>
