          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="post-subject">
                <h1>Badges</h1>
                <p> Use Badges for user experties and seniority. </p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="offset-lg-1 col-lg-10">
              <div className="author-info">
                <h4>Unlocked Socimo Badges.</h4>
                <p>You have to achieve the targeted amount to unlock a badge for the community</p>
              </div>
              <div className="row remove-ext">
                <div className="col-lg-12">
                  <ul className="badge-caro">
                    <li>
                      <img src="https://wpkixx.com/html/socimo/images/badges/year1.png" alt />
                      <span>Part of Socimo almost 1 year</span>
                      <div className="progress" style={{height: 10}}>
                        <div className="progress-bar" style={{width: '90%'}}>90%</div>
                      </div>
                    </li>
                    <li><img src="https://wpkixx.com/html/socimo/images/badges/year2.png" alt /></li>
                    <li><img src="https://wpkixx.com/html/socimo/images/badges/year3.png" alt /></li>
                    <li><img src="https://wpkixx.com/html/socimo/images/badges/year4.png" alt /></li>
                    <li><img src="https://wpkixx.com/html/socimo/images/badges/year5.png" alt /></li>
                    <li><img src="https://wpkixx.com/html/socimo/images/badges/year6.png" alt /></li>
                    <li><img src="https://wpkixx.com/html/socimo/images/badges/year7.png" alt /></li>
                    <li><img src="https://wpkixx.com/html/socimo/images/badges/year8.png" alt /></li>
                    <li><img src="https://wpkixx.com/html/socimo/images/badges/year9.png" alt /></li>
                    <li><img src="https://wpkixx.com/html/socimo/images/badges/year10.png" alt /></li>
                  </ul>
                </div>
                <div className="col-lg-12">
                  <ul className="nav nav-tabs about-btn">
                    <li className="nav-item"><a data-toggle="tab" href="#posts" className="active">All</a></li>
                    <li className="nav-item"><a data-toggle="tab" href="#pictures" className>Earned</a></li>
                    <li className="nav-item"><a data-toggle="tab" href="#videos" className>Unearned</a></li>
                  </ul>
                </div>
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge2.png" alt /></figure>
                    <h5>Male user</h5>
                    <p>Congratulations! You are the Socimo User</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge6.png" alt /></figure>
                    <h5>Female user</h5>
                    <p>Congratulations! You are the Socimo User</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge1.png" alt /></figure>
                    <h5>Legend Rank</h5>
                ...
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge4.png" alt /></figure>
                    <h5>Socimo Gift</h5>
                    <p>Spend some money for advertisment on Socimo.</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge5.png" alt /></figure>
                    <h5>100+ likes</h5>
                ...
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge3.png" alt /></figure>
                ...
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge7.png" alt /></figure>
                    <h5>Community Health</h5>
                    <p>Has participated in Socimo's Community Health research.</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge8.png" alt /></figure>
                    <h5>100+ refferal</h5>
                    <p>Reffer Socimo link and unlock the badge</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge9.png" alt /></figure>
                    <h5>1000+ shares</h5>
                ...
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge10.png" alt /></figure>
                    <h5>500+ followers</h5>
                ...
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge11.png" alt /></figure>
                    <h5>$1000 Earning</h5>
                    <p>Earn thousand dollors via Socimo stores products.</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge12.png" alt /></figure>
                    <h5>$5000 Earning</h5>
                    <p>Earn five thousand dollors via Socimo stores products.</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge13.png" alt /></figure>
                    <h5>$10,000 Earning</h5>
                    <p>Earn ten thousand dollors via Socimo stores products.</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge14.png" alt /></figure>
                    <h5>$100+ Earning</h5>
                    <p>Earn one Huderd dollors via Socimo stores products.</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge15.png" alt /></figure>
                    <h5>$250+ Earning</h5>
                ...
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge16.png" alt /></figure>
                    <h5>$500+ Earning</h5>
                    <p>Earn five hundred dollors via Socimo stores products..</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge17.png" alt /></figure>
                    <h5>Contributor</h5>
                    <p>Become contributor for Socimo and social network.</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge19.png" alt /></figure>
                    <h5>Channel Owner</h5>
                ...
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge20.png" alt /></figure>
                    <h5>Shirt Winner</h5>
                    <p>Win the competations of Socimo socials and get a shirt gift.</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-4 col-sm-6">
                  <div className="badge-box">
                    <figure><img src="https://wpkixx.com/html/socimo/images/badges/badge21.png" alt /></figure>
                    <h5>Tranding Posts</h5>
                    <p>You have tranding posts continuously from the Socimo.</p>
                  </div>
                </div>
              </div>
            </div>
