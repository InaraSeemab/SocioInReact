                ...
                <div className="col-lg-9">
                  <div className="main-wraper">
                    ...
                    <div className="blog-posts">
                      <figure><img src="https://wpkixx.com/html/socimo/images/resources/blog-list-1.jpg" alt /></figure>
                      <div className="blog-post-meta">
                        <ul>
                          <li><i className="icofont-read-book" /><a title="Reads" href="#">93k</a></li>
                        ...
                        <span><i className="icofont-clock-time" /> january 23, 2021</span>
                        <a href="blog-detail.html" title className="button primary circle">read more</a>
                      </div>
                    </div>
                    <div className="blog-posts">
                      <figure><img src="https://wpkixx.com/html/socimo/images/resources/blog-list-2.jpg" alt /></figure>
                      <div className="blog-post-meta">
                        <ul>
                          <li><i className="icofont-read-book" /><a title="Reads" href="#">93k</a></li>
                          <li><i className="icofont-comment" /><a title="comments" href="#">33</a></li>
                    ...
                    <div className="blog-posts">
                      <figure><img src="https://wpkixx.com/html/socimo/images/resources/blog-list-3.jpg" alt /></figure>
                      <div className="blog-post-meta">
                        <ul>
                          <li><i className="icofont-read-book" /><a title="Reads" href="#">93k</a></li>
                          <li><i className="icofont-comment" /><a title="comments" href="#">33</a></li>
                    ...
                    <div className="blog-posts">
                      <figure><img src="https://wpkixx.com/html/socimo/images/resources/blog-list-4.jpg" alt /></figure>
                      <div className="blog-post-meta">
                        <ul>
                          <li><i className="icofont-read-book" /><a title="Reads" href="#">93k</a></li>
                          <li><i className="icofont-comment" /><a title="comments" href="#">33</a></li>
                    ...
                    <div className="blog-posts">
                      <figure><img src="https://wpkixx.com/html/socimo/images/resources/blog-list-5.jpg" alt /></figure>
                      <div className="blog-post-meta">
                        <ul>
                          <li><i className="icofont-read-book" /><a title="Reads" href="#">93k</a></li>
                          <li><i className="icofont-comment" /><a title="comments" href="#">33</a></li>
