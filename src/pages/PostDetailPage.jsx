          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="post-subject">
                <a className="tagz" href="#" title>thesis</a>
                ...
                <ul className="sharing-options">
                  <li><a href="#" title><i className="icofont-id-card" /></a> Recommend</li>
                  <li><a href="#" title><i className="icofont-star" /></a> Follow</li>
                  <li><a href="#" title><i className="icofont-share-alt" /></a> Share</li>
                </ul>
                <ul className="nav nav-tabs post-detail-btn">
                  ...
                  <li className="nav-item"><a className href="#comment" data-toggle="tab">Comments</a></li>
                  <li className="nav-item"><a className href="#reference" data-toggle="tab">References</a></li>
                </ul>
                <a className="download-btn" href="#" title data-ripple>Download it</a>
              </div>
            </div>
          </div>
        </div>
              ...
              <div id="page-contents" className="row merged20">
                <div className="col-lg-8">
                  <div className="tab-content">
                    <div className="tab-pane fade active show" id="overview">
                      <div className="main-wraper">
                        <div className="post-detail">
                          <figure><img src="https://wpkixx.com/html/socimo/images/resources/post-detail.jpg" alt /></figure>
                          ...
                          <div className="pic-gallery">
                            <div className="row merged-10">
                              <div className="col-lg-6 col-md-6 col-sm-12 mb-3">
                                <img src="https://wpkixx.com/html/socimo/images/resources/gallery-1.jpg" alt />
                              </div>
                              <div className="col-lg-6 col-md-6 col-sm-12">
                                <div className="row">
                                  <div className="col-lg-12 col-md-12 col-sm-12">
                                    <img src="https://wpkixx.com/html/socimo/images/resources/gallery-2.jpg" alt />
                                  </div>
                                  <div className="col-lg-12 col-md-12 col-sm-12">
                                    <img src="https://wpkixx.com/html/socimo/images/resources/gallery-3.jpg" alt />
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div className="main-wraper">
                        <div className="charts">
                          <h4 className="mb-4">Post Analytics / Stats</h4>
                          <div className="quick-all-report">
                            <div className="row">
                              <div className="col-md-6">
                                <div className="quick-all"> <span id="quick-view" className="sparkline">6,4,7,2,9,8,2,5,4</span>
                              ...
                              <div className="col-md-6">
                                <div className="quick-all"> <span id="quick-time" className="sparkline">7,5,2,6,7,8,5,8,7</span>
                                  <div className="spark-meta">
                                    <h4>00:02:03</h4>
                                    <p>Recommend</p>
                                  </div>	
                              ...
                              <div className="col-md-6">
                                <div className="quick-all"> <span id="quick-returning" className="sparkline">4,6,7,8,3,5,8,6,5</span>
                                  <div className="spark-meta">
                                    <h4>25%</h4>
                                    <p>Shares</p>
                                  </div>	
                              ...
                              <div className="col-md-6">
                                <div className="quick-all"> <span id="quick-rate" className="sparkline">2,7,7,11,9,13,12,5,7</span>
                                  <div className="spark-meta">
                                    <h4>66.1%</h4>
                                    <p>References</p>
                                  </div>
                    ...
                    <div className="tab-pane fade mb-4" id="comment">
                            ...
                            <div className="comment-box">
                              ...
                              <div className="commenter-meta">
                                <div className="comment-titles">
                                  ...
                                  <a title href="#" className="reply">reply</a>
                                </div>
                                <p>
                    ...
                    <div className="tab-pane fade" id="reference">
                      <h4 className="mb-4">References (15)</h4>
                      <div className="main-wraper">
                        <div className="user-post">
                          <div className="friend-info">
                            ...
                            <div className="friend-name">
                              ...
                              <ins><a href="https://wpkixx.com/html/socimo/time-line.html" title>Sarah K.</a> added a chapter</ins>
                              <span><i className="icofont-globe" /> published: Sep,15 2020</span>
                            </div>
                            <div className="post-meta">
                              <a className="post-title" href="post-detail.html">Supervision as a Personnel Development Device</a>
                              <p>
                              ...
                              <div className="we-video-info">
                                <ul>
                                  ...
                                  <li>
                                    <span className="Recommend" title="recomend">
                                      <i className="icofont-id-card" />
                                    </span>
                                  </li>
                                  <li>
                                    <span className="Follow" title="follow">
                                      <i className="icofont-star" />
                                    </span>
                                  </li>
                                  <li>
                                    <span title="Share" className="share-pst">
                                      <i className="icofont-share-alt" />
                                      <ins>20</ins>
                                    </span>	
                                  </li>
                                </ul>
                                <a className="reply" title href="post-detail.html">Reply <i className="icofont-reply" /></a>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="user-post">
                          <div className="friend-info">
                            ...
                            <div className="friend-name">
                              ...
                              <ins><a href="https://wpkixx.com/html/socimo/time-line.html" title>Jack Carter</a> added a chapter</ins>
                              <span><i className="icofont-globe" /> published: Sep,15 2020</span>
                            </div>
                            <div className="post-meta">
                              <a className="post-title" href="post-detail.html">Supervision as a Personnel Development Device</a>
                        ...
                        <div className="user-post">
                          <div className="friend-info">
                            ...
                            <div className="friend-name">
                              ...
                              <ins><a href="https://wpkixx.com/html/socimo/time-line.html" title>William John</a> added a chapter</ins>
                              <span><i className="icofont-globe" /> published: Sep,15 2020</span>
                            </div>
                            <div className="post-meta">
                              <a className="post-title" href="post-detail.html">Supervision as a Personnel Development Device</a>
