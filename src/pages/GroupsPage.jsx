              ...
              <div id="page-contents" className="row merged20">
                <div className="col-lg-9">
                  <div className="main-wraper">
                    ...
                    <div className="col-lg-12">
                      <div className="load mb-4">
                        <ul className="pagination">
                          <li><a title href="#"><i className="icofont-arrow-left" /></a></li>
                          <li><a title href="#" className="active">1</a></li>
                          ...
                          <li><a title href="#"><i className="icofont-arrow-right" /></a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  <div className="main-wraper">
                    ...
                    <div className="rec-grp-caro">
                      <div className="row remove-ext-30">
                        <div className="col-lg-6 col-md-6 col-sm-12">
                          <div className="rec-group">
                            <span>Free</span>
                            <div className="rec-groupbox">
                              <figure><img src="https://wpkixx.com/html/socimo/images/resources/group-background.jpg" alt /></figure>
                              <div className="grp-dp"><img src="https://wpkixx.com/html/socimo/images/resources/group-avatar.jpg" alt /></div>
                            </div>
                            <div className="grp-name">
                              <h5><a href="group-detail.html"><i className="icofont-diamond" /> Jessica Killing <i className="icofont-tick-boxed" /></a></h5>
                              <span>@jessicakilling</span>
                              <a href="#" title="Join Group" data-toggle="tooltip"><i className="icofont-star" /></a>
                            </div>
                            <div className="more">
                              <div className="more-post-optns"><i className="icofont-dotted-down" />
                                <ul>
                                  <li><i className="icofont-pen-alt-1" />Show Only Free</li>
                                  <li><i className="icofont-ban" />Premium</li>
                                  <li><i className="icofont-ui-delete" />Hide From List</li>
                                </ul>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12">
                          <div className="rec-group">
                            <span>Free</span>
                            <div className="rec-groupbox">
                              <figure><img src="https://wpkixx.com/html/socimo/images/resources/group-background2.jpg" alt /></figure>
                              <div className="grp-dp"><img src="https://wpkixx.com/html/socimo/images/resources/group-avatar2.jpg" alt /></div>
                            </div>
                            <div className="grp-name">
                              <h5><a href="group-detail.html"><i className="icofont-diamond" /> Jessica Killing <i className="icofont-tick-boxed" /></a></h5>
                              <span>@jessicakilling</span>
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12">
                          <div className="rec-group">
                            <span>Free</span>
                            <div className="rec-groupbox">
                              <figure><img src="https://wpkixx.com/html/socimo/images/resources/group-background3.jpg" alt /></figure>
                              <div className="grp-dp"><img src="https://wpkixx.com/html/socimo/images/resources/group-avatar3.jpg" alt /></div>
                            </div>
                            <div className="grp-name">
                              <h5><a href="group-detail.html"><i className="icofont-diamond" /> Jessica Killing <i className="icofont-tick-boxed" /></a></h5>
                              <span>@jessicakilling</span>
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12">
                          <div className="rec-group">
                            <span>Free</span>
                            <div className="rec-groupbox">
                              <figure><img src="https://wpkixx.com/html/socimo/images/resources/group-background4.jpg" alt /></figure>
                              <div className="grp-dp"><img src="https://wpkixx.com/html/socimo/images/resources/group-avatar4.jpg" alt /></div>
                            </div>
                            <div className="grp-name">
                              <h5><a href="group-detail.html"><i className="icofont-diamond" /> Jessica Killing <i className="icofont-tick-boxed" /></a></h5>
                              <span>@jessicakilling</span>
