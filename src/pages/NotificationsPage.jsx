                  ...
                  <div className="main-wraper">
                    ...
                    <div className="editing-interest">
                      <div className="notification-box">
                        <ul>
                          <li>
                            <figure><img src="https://wpkixx.com/html/socimo/images/resources/friend-avatar.jpg" alt /></figure>
                            <div className="notifi-meta">
                              <p>bob frank like your post</p>
                              <span><i className="fa fa-thumbs-up" /> 30 mints ago</span>
                            </div>
                            <div className="more">
                              <div className="more-post-optns"><i className="icofont-caret-down" />
                                <ul>
                                  <li><i className="icofont-volume-mute" /> Mute</li>
                                  <li><i className="icofont-flag" /> Report</li>
                                  <li><i className="icofont-ban" /> Block</li>
                                </ul>
                              </div>
                            </div>
                          ...
                          <li>
                            <figure><img src="https://wpkixx.com/html/socimo/images/resources/friend-avatar2.jpg" alt /></figure>
                            <div className="notifi-meta">
                              <p>Sarah Hetfield commented on your photo. </p>
                              <span><i className="fa fa-comment" /> 1 hours ago</span>
                            </div>
                            <div className="more">
                              <div className="more-post-optns"><i className="icofont-caret-down" />
                                <ul>
                            ...
                            <i className="del icofont-close-circled" />
                          </li>
                          <li>
                            <figure><img src="https://wpkixx.com/html/socimo/images/resources/friend-avatar3.jpg" alt /></figure>
                            <div className="notifi-meta">
                              <p>Mathilda Brinker commented on your new profile status. </p>
                              <span><i className="fa fa-comment" /> 2 hours ago</span>
                            </div>
                            <div className="more">
                              <div className="more-post-optns"><i className="icofont-caret-down" />
                                <ul>
                          ...
                          <li>
                            <figure><img src="https://wpkixx.com/html/socimo/images/resources/friend-avatar4.jpg" alt /></figure>
                            <div className="notifi-meta">
                              <p>Motel Pitnik invited you to attend to his event Goo &amp; Gotham Bar. </p>
                              <span><i className="fa fa-address-card" /> 2 hours ago</span>
                            </div>
                            <div className="more">
                              <div className="more-post-optns"><i className="icofont-caret-down" />
                                <ul>
                          ...
                          <li>
                            <figure><img src="https://wpkixx.com/html/socimo/images/resources/friend-avatar5.jpg" alt /></figure>
                            <div className="notifi-meta">
                              <p>Chris Greyson liked your profile status. </p>
                              <span><i className="fa fa-thumbs-up" /> 1 day ago</span>
                            </div>
                            <div className="more">
                              <div className="more-post-optns"><i className="icofont-caret-down" />
                                <ul>
                          ...
                          <li>
                            ...
                            <div className="notifi-meta">
                              ...
                              <span><i className="fa fa-user" /> 2 days ago</span>
                            </div>
                            <div className="more">
                              <div className="more-post-optns"><i className="icofont-caret-down" />
                                <ul>
